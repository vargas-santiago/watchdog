...
public class AddAssignmentRequest {
    ...
    public boolean equals(Object o) {
        ...
        AddAssignmentRequest that = (AddAssignmentRequest) o;
    ...
    public AddAssignmentRequest(String id, String studentId) {
        this.id = id;
        this.studentId = studentId;
    }
    ...
    public AddAssignmentRequest(Builder builder) {
        this.id = builder.id;
    ...
    public static final class Builder {
        ...
        public AddAssignmentRequest build() {
            return new AddAssignmentRequest(this);
        }
    }
}
