...
public class UpdateClassRequest {
    ...
    public boolean equals(Object o) {
        ...
        UpdateClassRequest that = (UpdateClassRequest) o;
    ...
    public UpdateClassRequest(String id, String studentId) {
        this.id = id;
        this.studentId = studentId;
    }
    ...
    public UpdateClassRequest(Builder builder) {
        this.id = builder.id;
